...
/**
 *
 * @author Chandra Tungathurthi (tckb.504[at]gmail.com)
 *
 * Some new methods were added by Vishal Siramshetty (vishal[at]ebi.ac.uk)
 */
public class Utility {
    ...
    public static List stripBlanksInList(List<String> list) {
    ...
    public static List<String> extractLines(File file) {
        List<String> allLines = new ArrayList<>();
        //file = new File("/home/vishal/Desktop/smile.txt");
        Charset cs = StandardCharsets.UTF_8;
        List<String> lines;
        try {
            lines = Files.readAllLines(file.toPath(), cs);
    ...
    public static List<String> getNamesInFile(File f) {
        String[] entries = readFileAsLongString(f).split(WORD_BREAK);
